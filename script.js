...
// Referencias a elementos del DOM (AHORA FUERA DE DOMContentLoaded, como solían estar)
// Si alguno de estos IDs no existe en el HTML, causará un error "Cannot read properties of null"
...
// Asegurarse de que el DOM esté completamente cargado antes de interactuar con él
// Esta es una versión más simple que la que usamos con las comprobaciones if(elemento)
document.addEventListener('DOMContentLoaded', () => {
    // No necesitamos mover todas las referencias del DOM aquí si no usamos el if(elemento)
    // Pero si algunas referencias fallan por no existir en el HTML, causarán errores.
    // Esto es el comportamiento "anterior".
});
